...
public final class AppLinkQuickReply implements QuickReply{

	final String type = KakaoQuickReplyType.AL.toString();
	final String name;
	...
	public AppLinkQuickReply(Builder builder) {
    ...
    public static class Builder {
        ...
        public AppLinkQuickReply build() {

			if(name==null){
				throw new MissingFieldException("name field must not be null");
			}
			
            return new AppLinkQuickReply(this);
        }
    }
