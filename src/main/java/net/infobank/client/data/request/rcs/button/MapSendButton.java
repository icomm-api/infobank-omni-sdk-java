...
public final class MapSendButton implements Button{

	final String type = RcsButtonType.MAP_SEND.toString();
	final String name;

	public MapSendButton(Builder builder) {
