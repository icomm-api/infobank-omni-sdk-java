...
public class FriendtalkResponse extends ApiResponse{
    ...
    public static FriendtalkResponse fromJson(String json) {
        try {
            ObjectMapper mapper = new ObjectMapper();
            return mapper.readValue(json, FriendtalkResponse.class);
