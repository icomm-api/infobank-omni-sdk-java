...
public final class DeliverySearchButton implements Button{

	final String type = KakaoButtonType.DS.toString();
	final String name;

	public DeliverySearchButton(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeliverySearchButton build() {

			if(name==null){
				throw new MissingFieldException("name field must not be null");
			}

            return new DeliverySearchButton(this);
        }
    }
