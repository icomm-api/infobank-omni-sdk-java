...
public final class BotKeywordButton implements Button{

	final String type = KakaoButtonType.BK.toString();
	final String name;

	public BotKeywordButton(Builder builder) {
    ...
    public static class Builder {
        ...
        public BotKeywordButton build() {
            ...
            return new BotKeywordButton(this);
        }
    }
