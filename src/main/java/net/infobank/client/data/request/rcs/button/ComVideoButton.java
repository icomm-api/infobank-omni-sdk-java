...
public final class ComVideoButton implements Button{

	final String type = RcsButtonType.COM_V.toString();
	final String name;
	final String phoneNumber;

	public ComVideoButton(Builder builder) {
    ...
    public static class Builder {
        ...
        public ComVideoButton build() {
            ...
            return new ComVideoButton(this);
        }
    }
